...
namespace stepik
{
  ...
  public:
    ...
    {
      for (auto i = other.m_head;i!=nullptr;i=i->next)
          push_back(i->value);
    }
    ...
    iterator insert(iterator pos, const Type& value)
    {
      ...
      node <Type>*newNode = new node<Type>(value,pos.m_node,pos.m_node->prev);
   ...
   void push_back(const value_type& value)
    {
      ...
      m_tail->next = new node<Type>(value,nullptr, m_tail);
       m_tail = m_tail->next;
        ...
        else m_head = m_tail = new node<Type>(value, nullptr, nullptr);
    }
