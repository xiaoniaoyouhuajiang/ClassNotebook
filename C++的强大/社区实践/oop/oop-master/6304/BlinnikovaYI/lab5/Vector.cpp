...
namespace stepik {
	...
	public:
		...
		{
			unsigned int range = last - first;//диапазон
		...
		//Создает контейнер с содержимым other путём перемещения данных.
		...
		//Заменяет содержимое контейнера копией содержимого other.
		...
		//Заменяет содержимое с использованием семантики переноса
		...
		// assign method
		//Заменяет содержимое контейнера с копиями тех, кто в диапазоне [first, last)
		template <typename InputIterator>
		...
		//Если текущий размер больше count, контейнер сводится к ее первым элементам count.
