#ifndef MYFIGURES_HPP
#define MYFIGURES_HPP
...
public:
    ...
    virtual void PrintInfoAboutFigure(ostream& out) = 0;
    ...
    Dot getCentre() { return centre; }

    friend ostream& operator<<(ostream& out, Shape& sh)
    {
        sh.PrintInfoAboutFigure(out);
        return out;
    }
};
...
public:
    ...
    void PrintInfoAboutFigure(ostream& out) {
        ...
        out <<"Angle between l1 and l2 = " <<alpha <<endl;
...
public:
    ...
    void PrintInfoAboutFigure(ostream& out) {
        ...
        PrintShapeInfo(out);
        out <<"Edge1 lengtth = " <<edge1 <<endl;
        out <<"Edge2 lengtth = " <<edge2 <<endl;
        out <<"DOTS COORDINATES:\n";
        out <<"Dot point1: (" <<point1.x <<", " <<point1.y <<")\n";
        out <<"Dot point2: (" <<point2.x <<", " <<point2.y <<")\n";
        out <<"-----------------------------------------------";
        out <<endl;
    }
};
