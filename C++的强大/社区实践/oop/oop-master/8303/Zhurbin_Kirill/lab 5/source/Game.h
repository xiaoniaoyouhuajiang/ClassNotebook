...
protected:
    ...
    void createBase(int countBase){
        ...
        try {
            ...
            std::cout << "Logically incorrect data, enter data again" << std::endl;
            createBase(countBase);
        }
        catch (TypeInputException e){
            std::cout << e.what() << std::endl;
            std::cout << "Type input incorrect data, enter data again" << std::endl;
            createBase(countBase);
        }
        field->printAll();
    }

    void setGame(int countBase){
        ...
        if (commandStr == "load") {
            try {
                ...
                std::cout << e.what() << std::endl;
                std::cout << "It is impossible to load the game, a new game was created" << std::endl;
                createBase(countBase);
            }
            catch (LogicException e){
                std::cout << e.what() << std::endl;
