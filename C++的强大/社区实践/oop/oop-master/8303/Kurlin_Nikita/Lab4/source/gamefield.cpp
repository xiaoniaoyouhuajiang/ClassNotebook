...
GameField::GameField(int x, int y, int maxCount, int isCorrectCreated) : isCorrectCreated(isCorrectCreated), x(x), y(y), unitCount(0), maxCount(maxCount), base1(nullptr), base2(nullptr)
{		
