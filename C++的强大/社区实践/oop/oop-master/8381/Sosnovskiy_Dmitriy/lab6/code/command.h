...
protected:
    SaveGameData* data;
public:
    SaveGameCommand(GameFacade* receiverGameFacade, SaveGameData* data) {
        this->receiverGameFacade = receiverGameFacade;
        this->data = data;
    }
    void execute() override{
        this->receiverGameFacade->saveGame(data);
    }
};
...
protected:
    LoadGameData* data;
public:
    LoadGameCommand(GameFacade* receiverGameFacade, LoadGameData* data) {
        this->receiverGameFacade = receiverGameFacade;
        this->data = data;
    }
    void execute() override{
        this->receiverGameFacade->loadGame(data);
    }
};
