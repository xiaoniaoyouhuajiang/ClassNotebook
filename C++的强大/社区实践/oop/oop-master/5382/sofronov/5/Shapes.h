...
public:
    ...
    Arc() {
        Point p = Point(rand()%100000,rand()%100000);
        _center=p;
        _start=Point(p.x+(rand()%100),p.y+(rand()%100));
        _angle=rand()%360;
    }
    ...
    const double radius() const{
        double dx = fabs(_center.x - _start.x);
        double dy = fabs(_center.y - _start.y);
...
public:
    ...
    Circle() {
        _center=Point(rand()%100000,rand()%100000);
        _radius=rand()%100;
    }
...
public:
    ...
    Ellipse() {
        Point p = Point(rand()%100000,rand()%100000);
        _left_focus=p;
        _right_focus=Point(p.x+(rand()%100),p.y+(rand()%100));
    }
    ...
    const double radius() const{
        double dx = fabs(_left_focus.x - _right_focus.x);
        double dy = fabs(_left_focus.y - _right_focus.y);
