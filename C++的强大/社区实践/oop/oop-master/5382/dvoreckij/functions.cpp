...
Shape* generateShape() {
    switch (rand()%3) {
        case 0:
            return (new Triangle(RAND_IN_MAX, Point(RAND_IN_MAX, RAND_IN_MAX), Point(RAND_IN_MAX, RAND_IN_MAX)));
        case 1:
            return (new Rhombus(RAND_IN_MAX, RAND_IN_MAX, Point(RAND_IN_MAX, RAND_IN_MAX)));
        case 2:
            return (new Parallelogram(RAND_IN_MAX, RAND_IN_MAX, Point(RAND_IN_MAX, RAND_IN_MAX)));
    }
