...
#include "Archer.h"
namespace GameUnit {
    Archer::Archer(int startX, int startY, Weapon *unitWeapon, Armor *unitArmor) : RangedUnit(startX, startY,
    ...
    Archer::Archer(int startX, int startY, Weapon *unitWeapon, Armor *unitArmor, int numberInArray, int health,
