...
#include "Knight.h"
namespace GameUnit {
    Knight::Knight(int startX, int startY, Weapon *unitWeapon, Armor *unitArmor) : HeavyInfantry(startX, startY,
                                                                                                 unitWeapon,
                                                                                                 unitArmor) {
    ...
    Knight::Knight(int startX, int startY, Weapon *unitWeapon, Armor *unitArmor, int numberInArray, int health,
