    ...
    void execute(GameInfo &gameInfo, GameField &gameField) override{
        ...
        switch (unitType) {
            ...
            case UnitType::INFANTRY:
                gameInfo.getNowPlayerBase()->createUnit<Berserk>(unitPosition);
                break;
            case UnitType::ARCHER:
                gameInfo.getNowPlayerBase()->createUnit<CrossBowMan>(unitPosition);
                break;
            case UnitType::WIZARD:
                gameInfo.getNowPlayerBase()->createUnit<StormMage>(unitPosition);
                break;
