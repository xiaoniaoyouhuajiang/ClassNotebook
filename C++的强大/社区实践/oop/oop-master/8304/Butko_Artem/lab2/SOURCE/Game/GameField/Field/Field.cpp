...
{
    if ((field[x][y].object->id == 'M' || field[x][y].object->id == 'W'  || field[x][y].object->id == 'K' || field[x][y].object->id == 'S' || field[x][y].object->id == 'A' || field[x][y].object->id == 'C' )&& field[i][j].object != nullptr)
    {
